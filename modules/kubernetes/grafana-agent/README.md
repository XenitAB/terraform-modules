...
| <a name="input_extra_namespaces"></a> [extra\_namespaces](#input\_extra\_namespaces) | namespace to disable in grafana | `list(string)` | n/a | yes |
| <a name="input_ingress_nginx_metrics"></a> [ingress\_nginx\_metrics](#input\_ingress\_nginx\_metrics) | Will be set with extra\_namespaces in main.tf | `bool` | `false` | no |
