...
| <a name="input_defender_enabled"></a> [defender\_enabled](#input\_defender\_enabled) | Should Microsoft Defender for containers be enabled. This prohibits Trivy from also being installed. | `bool` | `false` | no |
