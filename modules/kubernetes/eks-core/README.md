...
| <a name="input_kube_state_metrics_namespaces_extras"></a> [kube\_state\_metrics\_namespaces\_extras](#input\_kube\_state\_metrics\_namespaces\_extras) | Comma-separated list of namespaces to be enabled except the ones defined by default. | `list(string)` | `[]` | no |
