...
| <a name="input_datadog_config"></a> [datadog\_config](#input\_datadog\_config) | Datadog configuration | <pre>object({<br>    datadog_site = string<br>    api_key      = string<br>    app_key      = string<br>    namespaces   = list(string)<br>  })</pre> | `null` | no |
...
| <a name="input_fluxcd_v2_config"></a> [fluxcd\_v2\_config](#input\_fluxcd\_v2\_config) | Configuration for fluxcd-v2 | <pre>object({<br>    github = optional(object({<br>      org             = string<br>      app_id          = number<br>      installation_id = number<br>      private_key     = string<br>    }))<br>    azure_devops = optional(object({<br>      pat  = string<br>      org  = string<br>      proj = string<br>    }))<br>  })</pre> | n/a | yes |
