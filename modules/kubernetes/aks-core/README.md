...
| <a name="input_ingress_config"></a> [ingress\_config](#input\_ingress\_config) | Ingress configuration | <pre>object({<br>    http_snippet                  = string<br>    name_override                 = string<br>    internal_load_balancer        = bool<br>    multiple_ingress              = bool<br>    private_default_ingress_class = bool<br>  })</pre> | <pre>{<br>  "http_snippet": "",<br>  "internal_load_balancer": false,<br>  "multiple_ingress": false,<br>  "name_override": "ingress-nginx",<br>  "private_default_ingress_class": false<br>}</pre> | no |
