...
| <a name="input_datadog_config"></a> [datadog\_config](#input\_datadog\_config) | Datadog configuration | <pre>object({<br><br>    datadog_site         = string<br>    namespaces           = list(string)<br>    apm_ignore_resources = list(string)<br>    role_arn             = string<br>  })</pre> | <pre>{<br>  "apm_ignore_resources": [<br>    ""<br>  ],<br>  "datadog_site": "",<br>  "namespaces": [<br>    ""<br>  ],<br>  "role_arn": ""<br>}</pre> | no |
