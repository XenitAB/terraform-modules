...
| <a name="input_contour_config"></a> [contour\_config](#input\_contour\_config) | Contour configuration | <pre>object({<br/>    ingress_enabled = optional(bool, true)<br/>    replica_count   = optional(number, 2)<br/>    resource_preset = optional(string, "small")<br/>  })</pre> | `{}` | no |
