...
| <a name="input_ingress_config"></a> [ingress\_config](#input\_ingress\_config) | Ingress configuration | <pre>object({<br>    http_snippet                    = string<br>    public_private_enabled          = bool<br>    allow_snippet_annotations       = bool<br>    deny_default_annotation_blocker = bool<br>  })</pre> | <pre>{<br>  "allow_snippet_annotations": false,<br>  "deny_default_annotation_blocker": false,<br>  "http_snippet": "",<br>  "public_private_enabled": false<br>}</pre> | no |
