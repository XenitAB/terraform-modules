...
| <a name="input_default_gateway_config"></a> [default\_gateway\_config](#input\_default\_gateway\_config) | Configuration for the default shared gateway. | <pre>object({<br/>    enabled            = optional(bool, false)<br/>    wildcard_hostname  = string<br/>    private_lb_gateway = optional(bool, false)<br/>  })</pre> | n/a | yes |
