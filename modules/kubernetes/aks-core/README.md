...
| <a name="input_ingress_config"></a> [ingress\_config](#input\_ingress\_config) | Ingress configuration | <pre>object({<br>    http_snippet              = string<br>    public_private_enabled    = bool<br>    allow_snippet_annotations = bool<br>    external_dns_hostname     = string<br>  })</pre> | <pre>{<br>  "allow_snippet_annotations": false,<br>  "external_dns_hostname": "",<br>  "http_snippet": "",<br>  "public_private_enabled": false<br>}</pre> | no |
