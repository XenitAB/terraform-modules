...
data "azuread_group" "resource_group_owner" {
  ...
  display_name = "${var.eks_group_name_prefix}${var.group_name_separator}rg${var.group_name_separator}${var.subscription_name}${var.group_name_separator}${var.environment}${var.group_name_separator}${each.key}${var.group_name_separator}owner"
}
...
data "azuread_group" "resource_group_contributor" {
  ...
  display_name = "${var.eks_group_name_prefix}${var.group_name_separator}rg${var.group_name_separator}${var.subscription_name}${var.group_name_separator}${var.environment}${var.group_name_separator}${each.key}${var.group_name_separator}contributor"
}
...
data "azuread_group" "resource_group_reader" {
  ...
  display_name = "${var.eks_group_name_prefix}${var.group_name_separator}rg${var.group_name_separator}${var.subscription_name}${var.group_name_separator}${var.environment}${var.group_name_separator}${each.key}${var.group_name_separator}reader"
}
