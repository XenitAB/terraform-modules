...
| <a name="input_grafana_k8s_monitor_config"></a> [grafana\_k8s\_monitor\_config](#input\_grafana\_k8s\_monitor\_config) | Configuration for the username and password | <pre>object({<br/>    grafana_cloud_prometheus_host     = string<br/>    grafana_cloud_loki_host           = string<br/>    grafana_cloud_tempo_host          = string<br/>    azure_key_vault_name              = string<br/>    include_namespaces                = string<br/>    exclude_namespaces                = optional(list(string), [])<br/>    node_exporter_node_affinity_key   = optional(string)<br/>    node_exporter_node_affinity_value = optional(string)<br/>  })</pre> | <pre>{<br/>  "azure_key_vault_name": "",<br/>  "exclude_namespaces": [<br/>    ""<br/>  ],<br/>  "grafana_cloud_loki_host": "",<br/>  "grafana_cloud_prometheus_host": "",<br/>  "grafana_cloud_tempo_host": "",<br/>  "include_namespaces": "",<br/>  "node_exporter_node_affinity_key": "",<br/>  "node_exporter_node_affinity_value": ""<br/>}</pre> | no |
