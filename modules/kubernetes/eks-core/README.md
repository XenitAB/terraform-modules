...
| <a name="input_cert_manager_config"></a> [cert\_manager\_config](#input\_cert\_manager\_config) | Cert Manager configuration | <pre>object({<br>    notification_email = string<br>    dns_zones          = list(string)<br>    role_arn           = string<br>  })</pre> | n/a | yes |
...
| <a name="input_ingress_healthz_dns_zone"></a> [ingress\_healthz\_dns\_zone](#input\_ingress\_healthz\_dns\_zone) | The ingress-healthz dns zone that should be used | `string` | n/a | yes |
