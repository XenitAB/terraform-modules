...
| <a name="input_aks_automation_config"></a> [aks\_automation\_config](#input\_aks\_automation\_config) | AKS automation configuration | <pre>object({<br>    public_network_access_enabled = optional(bool, false),<br>    runbook_schedules = optional(list(object({<br>      name        = string,<br>      frequency   = string,<br>      interval    = optional(number, 1),<br>      start_time  = string, # ISO 8601 format<br>      expiry_time = optional(string, ""),<br>      description = string,<br>      week_days   = optional(list(string), []),<br>      operation   = string,<br>      node_pools  = optional(list(string), []),<br>    })), [])<br>  })</pre> | `{}` | no |
