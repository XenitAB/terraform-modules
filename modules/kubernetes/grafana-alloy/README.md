...
| <a name="input_grafana_alloy_config"></a> [grafana\_alloy\_config](#input\_grafana\_alloy\_config) | Configuration for the username and password | <pre>object({<br/>    configmap = string<br/>  })</pre> | <pre>{<br/>  "configmap": ""<br/>}</pre> | no |
