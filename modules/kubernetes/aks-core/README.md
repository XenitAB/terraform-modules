...
| <a name="input_promtail_config"></a> [promtail\_config](#input\_promtail\_config) | Configuration for promtail | <pre>object({<br>    azure_key_vault_name  = string<br>    grafana_cloud_address = string<br>    loki_address          = string<br>    excluded_namespaces   = list(string)<br>  })</pre> | <pre>{<br>  "azure_key_vault_name": "",<br>  "excluded_namespaces": [],<br>  "grafana_cloud_address": "",<br>  "loki_address": ""<br>}</pre> | no |
