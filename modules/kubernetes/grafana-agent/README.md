...
| <a name="input_ingress_nginx_metrics"></a> [ingress\_nginx\_metrics](#input\_ingress\_nginx\_metrics) | Will be set with extra\_namespaces in main.tf | `bool` | n/a | yes |
