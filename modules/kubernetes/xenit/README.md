...
| Name | Type |
|------|------|
| [helm_release.xenit_proxy](https://registry.terraform.io/providers/hashicorp/helm/2.1.1/docs/resources/release) | resource |
| [helm_release.xenit_proxy_extras](https://registry.terraform.io/providers/hashicorp/helm/2.1.1/docs/resources/release) | resource |
...
| <a name="input_loki_api_path"></a> [loki\_api\_path](#input\_loki\_api\_path) | The loki api path | `string` | `"/"` | no |
...
| <a name="input_thanos_receiver_path"></a> [thanos\_receiver\_path](#input\_thanos\_receiver\_path) | The thanos receiver fqdn | `string` | `"/"` | no |
