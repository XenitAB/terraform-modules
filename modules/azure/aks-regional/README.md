...
| <a name="input_azuread_group_edit_id"></a> [azuread\_group\_edit\_id](#input\_azuread\_group\_edit\_id) | The group id of azure ad group edit | `list(string)` | n/a | yes |
| <a name="input_azuread_group_view_id"></a> [azuread\_group\_view\_id](#input\_azuread\_group\_view\_id) | The group id of azure ad group edit | `list(string)` | n/a | yes |
