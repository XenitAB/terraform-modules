...
| <a name="input_grafana_cloud_address"></a> [grafana\_cloud\_address](#input\_grafana\_cloud\_address) | The address of the grafana cloud instance to send logs to | `string` | n/a | yes |
