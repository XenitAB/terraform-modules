...
| <a name="input_policy_json_create"></a> [policy\_json\_create](#input\_policy\_json\_create) | Create AWS IAM policy from the policy document in policy\_json | `bool` | `true` | no |
