...
| <a name="input_deny_default_annotation_blocker"></a> [deny\_default\_annotation\_blocker](#input\_deny\_default\_annotation\_blocker) | Should deny-default-annotation-blocker be enabled | `bool` | `false` | no |
