...
| <a name="input_azuread_group_edit_ids"></a> [azuread\_group\_edit\_ids](#input\_azuread\_group\_edit\_ids) | n/a | `map(string)` | n/a | yes |
| <a name="input_azuread_group_view_ids"></a> [azuread\_group\_view\_ids](#input\_azuread\_group\_view\_ids) | n/a | `map(string)` | n/a | yes |
