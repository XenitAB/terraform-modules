...
| <a name="input_global_location_short"></a> [global\_location\_short](#input\_global\_location\_short) | The Azure region short namewhere the global resources resides. If not set, location\_short will be used | `string` | `null` | no |
