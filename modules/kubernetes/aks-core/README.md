...
| <a name="input_trivy_config"></a> [trivy\_config](#input\_trivy\_config) | Configuration for trivy | <pre>object({<br/>    metrics_vulnerability_id_enabled = optional(bool, false)<br/>    starboard_exporter_enabled       = optional(bool, true)<br/>  })</pre> | n/a | yes |
