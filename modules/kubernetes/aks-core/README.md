...
| <a name="input_xenit_fqdn"></a> [xenit\_fqdn](#input\_xenit\_fqdn) | Xenit Platform FQDNs | <pre>object({<br>    thanos_receiver = string<br>    loki_api        = string<br>  })</pre> | <pre>{<br>  "loki_api": "",<br>  "thanos_receiver": ""<br>}</pre> | no |
