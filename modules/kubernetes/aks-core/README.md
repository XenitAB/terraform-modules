...
| <a name="input_cert_manager_config"></a> [cert\_manager\_config](#input\_cert\_manager\_config) | Cert Manager configuration, the first item in the list is the main domain | <pre>object({<br>    notification_email = string<br>  })</pre> | n/a | yes |
...
| <a name="input_dns_zones"></a> [dns\_zones](#input\_dns\_zones) | DNS Zone to create ingress sub domain under | `list(string)` | n/a | yes |
