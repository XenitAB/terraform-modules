...
resource "git_repository_file" "identity" {
  path = "platform/${var.cluster_id}/prometheus/identity.yaml"
  content = templatefile("${path.module}/templates/identity.yaml.tpl", {
